...
<div class="my-5">
	...
	<c:forEach var="local" items="${travel.locals}">
		<div>${local.placeName } / ${local.roadAddressName } /
			${local.phone}</div>
	</c:forEach>
</div>
...
<form action="remove" method="post" name="removeForm">
	<input type="hidden" name="${_csrf.parameterName}"
		...
		value="${travel.no }" /> <input type="hidden" name="pageNum"
...
<script type="text/javascript"
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=1d3200cdac5443c1aa08492f07588b53&libraries=services"></script>
<!-- kakao map api & Geocoder api -->
<script>
